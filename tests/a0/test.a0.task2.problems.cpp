...
// A0T2: Problem 1
// TODO: Uncomment the function below by removing the surrounding /* and */, and
// run in test mode.
...
Test test_a0_task2_problems_print("a0.task2.problems.print", []() {
  ...
  printf(
      "\n1. printf with format specifiers such as string %s, interger %d, "
      "and float %f.\n",
      str.c_str(), integer, flt);

  std::cout
      << "2. std::cout and std::endl with multiple insertion operators like "
...
Test test_a0_task2_problems_numerical("a0.task2.problems.numerical", []() {
  ...
  if (Test::differs(target[0], expected[0]) ||
      Test::differs(target[1], expected[1]) ||
      Test::differs(target[2], expected[2]))
...
//       Find the reason why the function below reports a count too high and fix
//       it.
